...
/* package black-jack-0.1.0.0 */
#ifndef VERSION_black_jack
#define VERSION_black_jack "0.1.0.0"
#endif /* VERSION_black_jack */
#ifndef MIN_VERSION_black_jack
#define MIN_VERSION_black_jack(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_black_jack */
...
#define CURRENT_COMPONENT_ID "black-jack-0.1.0.0-inplace-black-jack"
